        ...
        <div className="border border-border/45 bg-card/20 rounded-2xl p-5 md:p-6 space-y-6">
          <div className="flex items-center justify-between pb-4 border-b border-border/30">
            <div className="flex items-center gap-2.5">
              ...
              <h3 className="text-base font-bold text-foreground uppercase tracking-wider">Teknik Analiz</h3>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              ...
              <div key={item.label} className="p-3.5 border border-border/40 rounded-xl bg-muted/10">
                ...
                <span className={`text-base font-bold ${item.bull === true ? 'text-emerald-500' : item.bull === false ? 'text-destructive' : 'text-foreground'}`}>{item.value}</span>
              </div>
            ))}
          </div>
