...
function LandingPage() {
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
      ...
      {/* Full-width Hero */}
      <section className="relative w-full shrink-0 pt-16 pb-10 md:pt-20 md:pb-12 px-6 flex flex-col items-center text-center overflow-hidden">
      ...
      <div className="flex-1 flex flex-row min-w-0 overflow-hidden">
        ...
        {/* Left: Index Cards + Quick Actions */}
        <div className={`flex-1 flex flex-col min-w-0 relative overflow-hidden ${isChatMaximized ? 'hidden md:hidden' : ''}`}>
