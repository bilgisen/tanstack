...
function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black px-6">
      <Link 
        to="/" 
        className="absolute top-8 left-8 flex items-center gap-2 text-white/50 hover:text-white transition-colors body-sm font-semibold"
      >
        <ArrowLeft size={16} />
        Geri Dön
      </Link>
      ...
      <div className="w-full max-w-sm text-center">
        ...
        <h1 className="display-md mb-4 text-white">Hemen Bağlanın</h1>
        
        <p className="body-md text-white/50 mb-12">
          Google ile hemen bağlanın, ücretsiz deneyin. <br/> Kredi kartı gerektirmez.
        </p>
        
        <button 
          onClick={handleGoogleLogin}
          className="btn-revolut-primary w-full shadow-xl"
        >
        ...
        <p className="mt-8 text-[11px] text-white/30 uppercase font-bold tracking-widest">
